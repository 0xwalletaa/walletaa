...
# 连接到Mainnet的节点列表
web3s = [
    Web3(Web3.HTTPProvider("https://api.zan.top/eth-mainnet")),
    Web3(Web3.HTTPProvider("https://endpoints.omniatech.io/v1/eth/mainnet/public")),
    Web3(Web3.HTTPProvider("https://eth-mainnet.public.blastapi.io")),
    Web3(Web3.HTTPProvider("https://eth.drpc.org")),
    Web3(Web3.HTTPProvider("https://0xrpc.io/eth"))
]
# 并行线程数
NUM_THREADS = 4
# 数据过期时间（秒）
