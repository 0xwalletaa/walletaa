...
while true; do
    ...
    if [ $counter -eq 30 ]; then
        python3 get_tvl.py --name mainnet --endpoints https://api.zan.top/eth-mainnet https://endpoints.omniatech.io/v1/eth/mainnet/public https://eth-mainnet.public.blastapi.io https://eth.drpc.org https://0xrpc.io/eth
