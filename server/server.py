...
def get_data():
    ...
    try:
        ...
        with data_lock:
            ...
            relayers_by_authorization_fee = loaded_data['relayers_by_authorization_fee']
...
def get_codes_by_authorizer_count():
    try:
        ...
        if search_by != '':
            current_codes_by_authorizer_count = [
                code for code in current_codes_by_authorizer_count 
                if util.is_target_code_info_item(code, search_by)
            ]
